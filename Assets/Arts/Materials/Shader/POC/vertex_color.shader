...
Shader "Shader Forge/vertex_color" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _a_blend_texture; uniform float4 _a_blend_texture_ST;
            uniform float _alpha_value;
...
////// Specular:
                ...
                float2 node_8204 = (i.uv0*_alpha_uv_value);
                float4 _a_blend_texture_var = tex2D(_a_blend_texture,TRANSFORM_TEX(node_8204, _a_blend_texture));
                float3 diffuseColor = (lerp(lerp(lerp(lerp(_main_texture_var.rgb,_r_blend_texture_var.rgb,i.vertexColor.r),_g_blend_texture_var.rgb,i.vertexColor.g),_b_blend_texture_var.rgb,i.vertexColor.b),_a_blend_texture_var.rgb,(i.vertexColor.a*_alpha_value))*i.vertexColor.rgb); // Need this for specular when using metallic

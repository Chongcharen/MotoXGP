...
public class PlayerEquipment : MonoBehaviour
{
    ...
    public async void SetupEquipment(Dictionary<string,PlayerEquipedData> data){
        ...
        foreach (var mapper in data)
        {
            ...
            // Debug.Log("model name "+GameDataManager.Instance.gameConfigData.dataPath.equipment_models+mapper.Value.model_name);
            // Debug.Log("texture name "+GameDataManager.Instance.gameConfigData.dataPath.equipment_textures+mapper.Value.texture_name);
            var textureQuality = useTextureHD ? "HD/" :"SD/";

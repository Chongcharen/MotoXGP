    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 node_7273 = _Time;
                float node_5381 = (sin(mul(unity_ObjectToWorld, v.vertex).r)*(_Intensity*(o.uv0.g*cos(node_7273.g))));
                v.vertex.xyz += (o.vertexColor.rgb*float3(node_5381,0.0,node_5381));
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(i.uv0, _MainTex));
                o.Emission = (i.vertexColor.rgb*_MainTex_var.rgb);
                
                float3 diffColor = float3(0,0,0);
                float node_3 = 0.2;
                float3 specColor = float3(node_3,node_3,node_3);
                float roughness = 1.0 - _Glosness;
